...
def make_profile_card(
    ...
    if badge:
        ...
        title_x = badge_x + badge.size[0] + S(18)
    else:
        title_x = badge_x
...
# HEADER = (185, 185, 200, 255)
    ...
    draw.text((grid_right_x, row1_y + S(76)), f"{wr}% win rate", font=f_small, fill=SUB)
